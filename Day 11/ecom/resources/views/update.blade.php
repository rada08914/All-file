        ...
        <div class="col-12 mt-5">
          <form action="{{URL::route('update.save',$data->id)}}" method="post">
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control" name="entrance_fee"  value="{{$data->seller_name}}" required>
            </div>
            <div class="mb-3">
                <label class="form-label">Rating</label>
                <input type="number" class="form-control" name="rating"  value="{{$data->rating}}" required>
            </div>
            <div class="mb-3">
